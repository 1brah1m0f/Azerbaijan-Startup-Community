...
const base: Record<ButtonVariant, string> = {
  ...
  outline:
    "inline-flex items-center justify-center rounded-full px-5 py-2.5 font-semibold text-brand-blue border-2 border-brand-blue/20 hover:border-brand-cyan hover:text-brand-teal transition-all duration-300 shrink-0",
  heroPrimary:
