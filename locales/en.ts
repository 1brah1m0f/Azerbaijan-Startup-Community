...
export const en: Dictionary = {
  ...
  account: {
    ...
    submitted: "Submitted",
    startupProfile: "Your startup profile",
    mentorProfile: "Your mentor profile",
    startupMatches: "Mentors who fit you",
    mentorMatches: "Startups who fit you",
    noMatches:
      "No matches yet. They will appear here as more people join the network.",
    introNote: "Contact details are not shown. ASC makes the introduction.",
    fit: "Fit",
    labelStage: "Stage",
    labelSector: "Sector",
    labelNeeds: "Needs",
    ...
    labelIndustries: "Industries",
    labelSupports: "Supports",
    labelAvailability: "Time per month",
    nothingYet: "No submission was found for this email.",
  },
  ...
  auth: {
    ...
    signupSubtitle: "Use the email address you registered with",
    ...
    errorInvalid: "That email or password is not right.",
    errorNotRegistered:
      "No submission was found for this email. Please fill in the form below first.",
    errorAlreadyRegistered: "An account already exists for this email. Log in.",
    errorWeakPassword: "The password must be at least 8 characters.",
    errorFailed: "That did not work. Please try again shortly.",
